...
(function () {
  ...
  /* ---------- food-kind emoji (from dish names; first match wins, none = no emoji) ---------- */
    ...
    { id: "cake", emoji: "🍰", re: /\b(cakes?|cheesecake|brownies?|puddings?|jello|custard|flan|trifle|cobbler|parfait|crepes?)\b/i },
    ...
    { id: "beef", emoji: "🥩", re: /\b(lamb|beef|steak|roast ?beef|brisket|ribs?|salami|prosciutto|pastrami|corned ?beef|pepperoni|meat|sirloin|meatballs?)\b/i },
    ...
    { id: "sausage", emoji: "🌭", re: /\b(sausages?|chorizo|andouille|hot ?dog|frankfurter|patties?|links?)\b/i },
    { id: "sandwich", emoji: "🥪", re: /\b(sandwiches?|subs?|wraps?|panini|pitas?|club ?house|egg ?rolls?|patty ?melt|sloppy ?joes?)\b/i },
    ...
    { id: "soup", emoji: "🍲", re: /\b(soups?|stew|chilis?|bisque|chowder|pakora|curry|grav(y|ies)|makhani|vindaloo|broth)\b/i },
    { id: "beans", emoji: "🫘", re: /\b(bean|beans|lentils?|chickpeas?|hummus|falafels?|frijoles)\b/i },
    { id: "potato", emoji: "🥔", re: /\b(potato|potatoes?|fries|frites|mashed|gratin|hash ?browns?|taters?)\b/i },
    { id: "noodle", emoji: "🍜", re: /\b(pad thai|ramen|sushi|dumplings?|spring ?rolls?|lo ?mein|chow ?mein|pho|udon|soba|wontons?)\b/i },
    { id: "pasta", emoji: "🍝", re: /\b(pasta|macaroni|spaghetti|noodles?|penne|fettuccine|lasagna|gnocchi|orzo|farfalle|couscous)\b/i },
    { id: "rice", emoji: "🍚", re: /\b(rice|risotto|basmati|quinoa|arroz)\b/i },
    { id: "omelet", emoji: "🍳", re: /\b(omelets?|omelettes?|strata)\b/i },
  { id: "egg", emoji: "🥚", re: /\b(eggs?|scrambled?|scrambles?|scramble)\b/i },
    { id: "cheese", emoji: "🧀", re: /\b(cheese|queso|mozzarella)\b/i },
    ...
    { id: "bread", emoji: "🍞", re: /\b(bread|breads?|breadsticks?|cornbread|buns?|rolls?|biscuits?|crackers?|croutons|naan|focaccia|ciabatta|grinder|powerseed|seeded)\b/i },
    ...
    { id: "blueberry", emoji: "🫐", re: /\b(blueberr(y|ies)|berr(y|ies)|cranberries?)\b/i },
    { id: "peach",   emoji: "🍑", re: /\bpeach(es)?\b/i },
    ...
    { id: "citrus", emoji: "🍋", re: /\b(lemon|limes?|grapefruit)\b/i },
    { id: "boba",   emoji: "🧋", re: /\bboba\b/i },
    ...
    { id: "corn",    emoji: "🌽", re: /\b(corn|hominy)\b/i },
    { id: "onion",   emoji: "🧅", re: /\bonions?\b/i },
    { id: "garlic",  emoji: "🧄", re: /\bgarlic\b/i },
    { id: "tomato",  emoji: "🍅", re: /\b(tomatoes?|ratatouille)\b/i },
    { id: "avocado", emoji: "🥑", re: /\bavocado\b/i },
    { id: "olive",   emoji: "🫒", re: /\bolives?\b/i },
    { id: "cucumber", emoji: "🥒", re: /\bcucumbers?\b/i },
    { id: "mushroom", emoji: "🍄", re: /\b(mushrooms?|portobello|portabella|shiitake)\b/i },
    { id: "eggplant", emoji: "🍆", re: /\beggplant\b/i },
    { id: "hotpepper", emoji: "🌶️", re: /\b(jalapenos?|pepperoncinis?)\b/i },
    { id: "pepper",  emoji: "🫑", re: /\bpeppers?\b/i },
    { id: "pea",     emoji: "🫛", re: /\bpeas\b/i },
    { id: "leafy",   emoji: "🥬", re: /\b(spinach|kale|lettuce|romaine|arugula|greens?|spring ?mix|sprout ?mix|bok ?choy|kimchi|cabbage|sauerkraut|slaw|chard|chives)\b/i },
